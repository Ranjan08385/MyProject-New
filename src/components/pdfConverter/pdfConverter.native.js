...
export default class PrintPdf extends React.Component {
  static askPermission = async (
    ...
    try {
      ...
      const senderAccNum =
        responce.remAccountNumber !== null
          ? `XXXXXXXX${responce.remAccountNumber.slice(-3)}`
          : 'NA';
            ...
            <div class='fullContainer'>
              <div class='secondContainer'>
                <div class='divfirstRowSecondContainer'>
                  ...
                  ${getParsedDate(transDate)} </label> </div>
              ...
              <div class='senderRecieverContainer'>
                <div class='senderContainer'>
                  ...
                  <div> <label class='font16Label'>${
                    responce.getCustInfo.CITY
                  } , ${responce.getCustInfo.STATE} </label> </div>
                  <div> <label class='font16Label'>${
      ...
      alert('Write permission err' + ` ${err} ${responce}`);
    }
  };
}
