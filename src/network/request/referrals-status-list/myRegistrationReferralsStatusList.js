...
//   }
const GetMyRegistrationReferralsStatusList = customerDetails => {
  return {
    url: '/referralsStatusList/myRegReferralsStatusList',
    payload: customerDetails,
    type: Types.POST,
    tag: ApiTag.MY_REGISTARTION_REFERRALS_STATUS_LIST,
    headers: { 'Content-Type': 'application/json' },
  };
};

export default GetMyRegistrationReferralsStatusList;
